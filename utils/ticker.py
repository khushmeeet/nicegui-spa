...
def extract_symbol_and_suffix(ticker: str, all_symbols: list[Symbol]) -> Tuple[Optional[Symbol], Optional[str]]:
    ...
    matched_symbol_obj = next((s for s in all_symbols if s.symbol.upper() in cleaned_ticker), None)
